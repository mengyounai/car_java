...
public class JwtUtil {
    ...
    //加密所需的签发人
    private static final String ISS = "rings-b97488b4e0b8078c3b95cdec5a107e00";

    //创建默认的秘钥和算法，供无参的构造方法使用
    private static final String defaultbase64EncodedSecretKey = "sakura";
    ...
    private JwtUtil(String secretKey, SignatureAlgorithm signatureAlgorithm) {
    ...
    public String encode(Map<String, Object> claims) {
        ...
        JwtBuilder builder = Jwts.builder()
                ...
                .setSubject("无限缤纷")//3. 签发人，也就是JWT是给谁的（逻辑上一般都是username或者userId）
